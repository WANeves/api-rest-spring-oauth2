...
image::https://travis-ci.org/royclarkson/spring-rest-service-oauth.svg[![Build Status](https://travis-ci.org/WANeves/api-rest-spring-oauth2.svg?branch=master)](https://travis-ci.org/WANeves/api-rest-spring-oauth2)
